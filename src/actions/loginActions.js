...
export function toggleCodeButtonActive(){
    return {
        type:ActionTypes.TOGGLE_CODE_BUTTON_ACTIVE
    }
}

export function toggleAgreementActive(){
    return {
        type:ActionTypes.TOGGLE_AGREEMENT_ACTIVE
    }
}
